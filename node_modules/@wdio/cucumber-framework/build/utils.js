...
function getStepFromFeature(feature, pickle, stepIndex, sourceLocation) {
  ...
  feature.children.filter(child => child.type !== 'Background' && !(child.type.indexOf('Scenario') > -1 && !compareScenarioLineWithSourceLine(child, sourceLocation))).forEach(child => {
